...
2. Log a message within your code.
    ...
    - Decide on a 'level' for the message:
        ...
        - WARNING: situations where back-up procedures are needed, unexpected situations
        and possibly ordinary exceptions that have been caught
...
3. Start the logging system.
    ...
    it doesn't already exist; if it does, it will add new messages at the bottom under
    a start up message to the 'root' module.
