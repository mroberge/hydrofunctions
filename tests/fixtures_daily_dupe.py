...
daily_dupe = {'name': 'ns1:timeSeriesResponseType',
 'declaredType': 'org.cuahsi.waterml.TimeSeriesResponseType',
 'scope': 'javax.xml.bind.JAXBElement$GlobalScope',
 'value': {'queryInfo': {'queryURL': 'http://waterservices.usgs.gov/nwis/dv/format=json%2C1.1&sites=03107698&startDT=2017-04-23&endDT=2017-04-29',
   'criteria': {'locationParam': '[ALL:03107698]',
    'variableParam': 'ALL',
    'timeParam': {'beginDateTime': '2017-04-23T00:00:00.000',
     'endDateTime': '2017-04-29T00:00:00.000'},
    'parameter': []},
   'note': [{'value': '[ALL:03107698]', 'title': 'filter:sites'},
  ...
  'timeSeries': [{'sourceInfo': {'siteName': 'Traverse Creek near Kendall, PA',
     'siteCode': [{'value': '03107698',
       'network': 'NWIS',
       'agencyCode': 'USGS'}],
...
daily_dupe_altered = {'name': 'ns1:timeSeriesResponseType',
 'declaredType': 'org.cuahsi.waterml.TimeSeriesResponseType',
 'scope': 'javax.xml.bind.JAXBElement$GlobalScope',
 'value': {'queryInfo': {'queryURL': 'http://waterservices.usgs.gov/nwis/dv/format=json%2C1.1&sites=03107698&startDT=2017-04-23&endDT=2017-04-29',
   'criteria': {'locationParam': '[ALL:03107698]',
